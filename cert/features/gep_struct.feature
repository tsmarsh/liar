Feature: GetElementPtr with Struct Types
  ...
  Scenario: Access first field of a two-field struct
    ...
    And the function definition (define (get-x i64) ((ptr p)) (let ((field-ptr (getelementptr %struct.point p (i32 0) (i32 0)))) (ret (load i64 field-ptr))))
  ...
  Scenario: Access second field of a two-field struct
    Given the struct definition (defstruct point (i64 i64))
    And the function definition (define (get-y i64) ((ptr p)) (let ((field-ptr (getelementptr %struct.point p (i32 0) (i32 1)))) (ret (load i64 field-ptr))))
  ...
  Scenario: Modify struct field through GEP
    ...
    And the function definition (define (set-value void) ((ptr p) (i64 val)) (let ((field-ptr (getelementptr %struct.counter p (i32 0) (i32 0)))) (store val field-ptr) (ret)))
